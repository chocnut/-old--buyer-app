...
import { TouchableOpacity, StyleSheet, Image, Animated, Easing } from 'react-native';
        ...
        return (
            <Animated.View>
                ...
                >
                    ...
                    <Animated.View style={[ styles.btnContainer, { opacity: this.btnOpacity, transform: [{ translateY: this.btnPosition1 }] } ]}>
                        <MasterAddBtnSmall
                            title="New request"
                    ...
                    <Animated.View style={[ styles.btnContainer, { opacity: this.btnOpacity, transform: [{ translateY: this.btnPosition2 }] } ]}>
                        <MasterAddBtnSmall
                            title="Take photo"
                    ...
                    <Animated.View style={[ styles.btnContainer, { opacity: this.btnOpacity, transform: [{ translateY: this.btnPosition3 }] } ]}>
                        <MasterAddBtnSmall
                            title="Camera roll"
                    ...
                    <Animated.View style={[ styles.btnContainer, { transform } ]}>
                        <TouchableOpacity style={[ styles.addBtn ]} activeOpacity={1} onPress={this.close}>
                            <Image source={require('../assets/images/add.png')} style={styles.plus}/>
                        </TouchableOpacity>
                    </Animated.View>
                </Modal>
